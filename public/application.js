...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://secret-wave-91189.herokuapp.com',
...
var onShowUpdateTaskModal = function onShowUpdateTaskModal(event) {
  $('.modal').modal();
...
var onDeleteTask = function onDeleteTask(event) {
  ...
  .then(onShowTasks).catch(ui.deleteTaskFailure);
};
...
module.exports = {
  ...
  onUpdateTaskModal: onUpdateTaskModal,
...
if(false) {
	module.hot.accept("!!../../../css-loader/index.js?url=false!./materialize.min.css", function() {
		var newContent = require("!!../../../css-loader/index.js?url=false!./materialize.min.css");
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(16), __webpack_require__(16), __webpack_require__(16), __webpack_require__(52)))
...
var $export = __webpack_require__(0);
var invoke = __webpack_require__(57);
var partial = __webpack_require__(337);
...
var taskEvents = __webpack_require__(133);
...
$(function () {
  ...
  $('#show-tasks-list').on('click', '.taskDropdown', function () {
...
var onSignInToggle = function onSignInToggle() {
...
var store = __webpack_require__(94);
var appActions = __webpack_require__(132);
...
var updateTask = function updateTask(formData) {
  return $.ajax({
...
var updateTaskModal = function updateTaskModal(formData, modalId) {
  return $.ajax({
...
var showTasksTemplate = __webpack_require__(352);
var appActions = __webpack_require__(132);
...
var showTasksSuccess = function showTasksSuccess(responseData) {
  // Generate task listing with handlebars template.
  var showTasksHtml = showTasksTemplate({ tasks: responseData.tasks });
  $('.show-tasks-list').empty();
  $('.show-tasks-list').append(showTasksHtml);
};
// Display error message, then reset form fields.
var showTasksFailure = function showTasksFailure() {
  appActions.temporaryMessage('#user-message', 'Unable to load task listing');
  $('form').trigger('reset');
};

// Display error message, then reset form fields.
var createTaskFailure = function createTaskFailure() {
...
// Display error message, then reset form fields.
var deleteTaskFailure = function deleteTaskFailure() {
  appActions.temporaryMessage('#user-message', 'Unable to delete task');
  $('form').trigger('reset');
};

module.exports = {
  showTasksSuccess: showTasksSuccess,
  showTasksFailure: showTasksFailure,
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <section class=\"task\">\n    <ul class=\"collapsible popout\">\n        <li class=\"taskDropdown\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n\n          <div id=\"taskDropdown-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"collapsible-header\"><i class=\"material-icons right\">expand_more</i>"
    + alias2(__default(__webpack_require__(369)).call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.title : stack1),50,{"name":"limit","hash":{},"data":data,"blockParams":blockParams}))
    ...
    + ((stack1 = helpers["if"].call(alias3,((stack1 = blockParams[0][0]) != null ? stack1.target_date : stack1),{"name":"if","hash":{},"fn":container.program(6, data, 0, blockParams),"inverse":container.program(4, data, 0, blockParams),"data":data,"blockParams":blockParams})) != null ? stack1 : "")
    + "            </p>\n            <!-- Delete Button -->\n            <button type=\"submit\" class=\"delete-task-btn btn red btn-danger\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete!</button>\n            <!-- Modal Trigger -->\n            <a id=\"update-task-modal-btn-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"update-task-modal-btn btn green modal-trigger\" href=\"#updateTaskModal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Update</a>\n          </span></div>\n        </li>\n      </ul>\n\n    <!-- Modal Structure -->\n    <div id=\"updateTaskModal-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"modal\">\n      <div class=\"row\">\n        <div class=\"col s12 center\">\n          <form id=\"update-task-modal-form-"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"inner-fields update-task-modal-form\">\n            <div class=\"form-group\">\n              <label for=\"updateTask\">Update Task</label>\n              <div class=\"row\">\n                <div class=\"input-field col s12\">\n                  <input name=\"task[title]\" type=\"text\" class=\"validate\">\n                  <label for=\"updateTask\">Update Task Title</label>\n                </div>\n              </div>\n              <div class=\"row\">\n                <div class=\"input-field col s12\">\n                <input name=\"task[description]\" type=\"text\" class=\"validate\">\n                <label for=\"description\">Update Description</label>\n                </div>\n              </div>\n              <div class=\"row\">\n                <div class=\"input-field col s12\">\n                <input name=\"task[target_date]\" type=\"text\" class=\"validate\">\n                <label for=\"targetDate\">Update Date</label>\n                </div>\n              </div>\n              <div class=\"modal-footer\">\n                <input type=\"submit\" value=\"Update\" class=\"s12 btn btn-secondary modal-close\">\n              </div>\n            </div>\n          </form>\n        </div>\n      </div>\n    </div>\n  </section>\n\n";
  ...
  return "                "
    + container.escapeExpression(container.lambda(((stack1 = blockParams[1][0]) != null ? stack1.target_date : stack1), depth0))
    + "\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.tasks : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
// module
exports.push([module.i, "body {\n  text-align: center;\n  font-family: 'Source Code Pro', monospace;\n  background-image: url(\"public/should-wang-1401880-unsplash.jpg\");\n  background-position: center;\n  background-size: cover;\n  height: 100vh; }\n\n.bottom-message {\n  padding: .5rem;\n  color: red; }\n\n.collapsible-body {\n  background-color: white;\n  overflow: auto; }\n\n.nav-bar-style {\n  margin-bottom: .5em; }\n\n.title {\n  font-family: 'Source Code Pro', monospace;\n  font-size: 2.5em;\n  text-shadow: 1px 1px 2px red, 0 0 1em cyan, 0 0 0.2em cyan; }\n\n.welcome-title {\n  font-family: 'Source Code Pro', monospace;\n  color: white;\n  text-shadow: 1px 1px 2px red, 0 0 1em cyan, 0 0 0.2em cyan; }\n\n.input-field {\n  color: white; }\n\n.small-message {\n  color: white; }\n\n.hidden {\n  display: none; }\n\n@media (max-width: 540px) {\n  .title {\n    font-size: 1.5rem; } }\n", ""]);
